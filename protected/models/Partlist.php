...
class Partlist extends CActiveRecord
{
    ...
    {
        return array(
            array('created_at, country_id', 'numerical', 'integerOnly'=>true),
            array('name_text, url_text, serial_number', 'length', 'max'=>255),
            array('kazname_text', 'length', 'max'=>255),
            array('engname_text, file', 'length', 'max'=>255),
            array('country , partner_country', 'length', 'max'=>255),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'partner_country' => 'Страна партнера участника',
