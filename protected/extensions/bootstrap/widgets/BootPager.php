...
class BootPager extends CLinkPager
{
	...
	public function init()
	{
		...
		if ($this->nextPageLabel === null)
			$this->nextPageLabel=Yii::t('bootstrap','След.').' &rarr;';

		if ($this->prevPageLabel === null)
			$this->prevPageLabel='&larr; '.Yii::t('bootstrap','Пред.');

		if ($this->firstPageLabel === null)
			$this->firstPageLabel=Yii::t('bootstrap','Первая');

		if ($this->lastPageLabel === null)
			$this->lastPageLabel=Yii::t('bootstrap','Последняя');
