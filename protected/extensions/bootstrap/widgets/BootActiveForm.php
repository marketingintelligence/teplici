...
class BootActiveForm extends CActiveForm
{
	 ...
	 * @return string the generated row
	 */
	public function fileFieldRow($model, $attribute, $htmlOptions = array(),$language=false)
	{
		return $this->inputRow('filefield', $model, $attribute, null, $htmlOptions,$language);
	}
	/**
	 ...
	 * @return string the generated row
	 */
	public function textFieldRow($model, $attribute, $htmlOptions = array(),$language=false)
	{
		return $this->inputRow('textfield', $model, $attribute, null, $htmlOptions,$language);
	}
	
	/**
	 * Renders a data field input row.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	 * @return string the generated row
	...
	{
		return $this->inputRow('datefield', $model, $attribute, null, $htmlOptions);
	}

	/**
	 * Renders a date and time field input row.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	 * @return string the generated row
	 */
	public function dateTimeFieldRow($model, $attribute, $htmlOptions = array())
	{
		
		return $this->inputRow('datetimefield', $model, $attribute, null, $htmlOptions);
	}
	 ...
	 * @return string the generated row
	 */
	public function textAreaRow($model, $attribute, $htmlOptions = array(),$language=false)
	{
		return $this->inputRow(BootInput::TYPE_TEXTAREA, $model, $attribute, null, $htmlOptions,$language);
	}

	/**
	 * Renders a parent field input row.
	 * @param CModel $model the data model
	 * @param string $attribute the attribute
	 * @param array $htmlOptions additional HTML attributes
	 * @return string the generated row
	...
	public function autoFieldRow($model, $attribute, $htmlOptions = array(),$relation='')
	{
		if($relation!='')
			return $this->inputRow('autofield', $model, $attribute, null, $htmlOptions,false,$relation);
	}
	 ...
	 * @return string the generated row
	 */
	public function inputRow($type, $model, $attribute, $data = null, $htmlOptions = array(),$language=false,$relation=false)
	{
