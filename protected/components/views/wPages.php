...
if ($this->pages > 1):
    ...
    <div class="page-navi">
        ...
        if ($get['page'] == 1) {
            ...
            $mypage = "?page=".$get['page'];
        }
        if ($this->page > 1):?>
            <a href="<?=$mypage?>"><span class="link"> ← <?=$array[Yii::app()->session->itemAt('language')]['pred']?></span></a>
        <? else: $left = '#'; ?>
        ...
        for ($i = $beginPage; $i <= $endPage; ++$i) {
            ...
            if($this->page<=5 && $this->pages>5){
                ...
                if($i<6){
                    ...
                    if($i==5){
                        ...
                        $get['page'] = $this->pages;
                        echo '<a class="page" href="?page='.$get['page'].'">'.$this->pages.'</a>';
                    }
                }
            }
            ...
            if($this->page >=5 && $this->pages>8 && $this->pages-5 > $i){
                ...
                if($this->page<$i && $max==0){
                    ...
                    if($i==$gettop){
                        /*echo '<a class="page" href="?page='.$get['page'].'">1</a>';
                        echo '<span class="page">...</span>';
                        $get['page'] = $this->page-2;
                        echo '<a class="page" href="?page='.$get['page'].'">'. $getcmin2 .'</a>';
                        $get['page'] = $this->page-1;
                        echo '<a class="page" href="?page='.$get['page'].'">'. $getcmin1 .'</a>';*/
