<?php
    ...
    echo CHtml::hiddenField('Social_page',$_GET['Social_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Social_page'=>$_GET['Social_page'])); ?>    </div>
        ...
        <?php echo $form->textFieldRow($model, 'short_description', array('size' => 60, 'maxlength' => 255, 'class'=>'span')); ?>
        <?php echo $form->dropDownListRow($model, 'serial_number', $number, array('class'=>'span-number')); ?>
<!--
        <?php /*echo $form->textAreaRow($model, 'short_description', array('size' => 60, 'maxlength' => 255, 'class'=>'span12')); */?>
        <?php /*echo $form->textAreaRow($model, 'description',array('class'=>'span12'));; */?>
        <?php /*$this->widget('application.extensions.elrte.elRTE', array('model'=>$model,'attribute'=>'description')); */?>
...
<!--        --><?php /*echo $form->dateFieldRow($model, 'created_at',array('class'=>'span2'));; */?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Social_page'=>$_GET['Social_page'])); ?>
	</div>

<script>
    $('#Social_name_text').change(function() {
        $('#Social_url_text').val(cyr2lat($('#Social_name_text').val()));
    });
