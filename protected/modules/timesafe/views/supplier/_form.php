<?php
    ...
    echo CHtml::hiddenField('Supplier_page',$_GET['Supplier_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Supplier_page'=>$_GET['Supplier_page'])); ?>    </div>
        ...
        <?php echo $form->textAreaRow($model, 'short_bigtext', array('size' => 60, 'maxlength' => 10000, 'class'=>'span12')); ?>
        <?php echo $form->textAreaRow($model, 'engshort_bigtext', array('size' => 60, 'maxlength' => 10000, 'class'=>'span12')); ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Supplier_page'=>$_GET['Supplier_page'])); ?>
	</div>

<script>
    $('#Supplier_name_text').change(function() {
        $('#Supplier_url_text').val(cyr2lat($('#Supplier_name_text').val()));
    });
