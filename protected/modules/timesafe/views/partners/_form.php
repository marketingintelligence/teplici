<?php
    ...
    echo CHtml::hiddenField('Partners_page',$_GET['Partners_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Partners_page'=>$_GET['Partners_page'])); ?>
	</div>

<script>
    $('#Partners_name_text').change(function() {
        $('#Partners_url_text').val(cyr2lat($('#Partners_name_text').val()));
    });
