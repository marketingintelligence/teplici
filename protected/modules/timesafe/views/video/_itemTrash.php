<div class="row">
    ...
    <div class="offset3">
        <p class="pull-right">
            ...
            <a  class="btn danger" data-type="delete"  href="<?=$this->createUrl('Video/delete', array('id'  => $data->id,'ajax' => true))?>" data-title="<?=CHtml::encode($data->name_text)?>" data-id="<?=$data->id?>"><i class="icon-trash"></i> Уд.</a>
        </p>
