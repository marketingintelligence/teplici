<?php
    ...
    echo CHtml::hiddenField('Extext_page',$_GET['Extext_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Extext_page'=>$_GET['Extext_page'])); ?>
	</div>

<script>
    $('#Extext_name_text').change(function() {
        $('#Extext_url_text').val(cyr2lat($('#Extext_name_text').val()));
    });
