<?php
    ...
    echo CHtml::hiddenField('Combinates_page',$_GET['Combinates_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Combinates_page'=>$_GET['Combinates_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Combinates_page'=>$_GET['Combinates_page'])); ?>
	</div>

<script>
    $('#Combinates_name_text').change(function() {
        $('#Combinates_url_text').val(cyr2lat($('#Combinates_name_text').val()));
    });
