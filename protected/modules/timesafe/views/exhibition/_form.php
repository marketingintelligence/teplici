<?php
    ...
    echo CHtml::hiddenField('Exhibition_page',$_GET['Exhibition_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Exhibition_page'=>$_GET['Exhibition_page'])); ?>    </div>
        ...
        <?php echo $form->textAreaRow($model, 'engshort_bigtext', array('size' => 60, 'maxlength' => 450, 'class'=>'span12')); ?>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Exhibition_page'=>$_GET['Exhibition_page'])); ?>
	</div>

<script>
    $('#Exhibition_name_text').change(function() {
        $('#Exhibition_url_text').val(cyr2lat($('#Exhibition_name_text').val()));
    });
