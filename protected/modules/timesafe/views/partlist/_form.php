...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
        ...
        <?php echo $form->textFieldRow($model, 'country', array('size' => 60, 'maxlength' => 255, 'class'=>'span')); ?>
        <?php echo $form->textFieldRow($model, 'partner_country', array('size' => 60, 'maxlength' => 255, 'class'=>'span')); ?>
