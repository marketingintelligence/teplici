<?php
    ...
    echo CHtml::hiddenField('Countries_page',$_GET['Countries_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Countries_page'=>$_GET['Countries_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Countries_page'=>$_GET['Countries_page'])); ?>
	</div>

<script>
    $('#Countries_name_text').change(function() {
        $('#Countries_url_text').val(cyr2lat($('#Countries_name_text').val()));
    });
