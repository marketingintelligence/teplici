<?php
    ...
    echo CHtml::hiddenField('Exupload_page',$_GET['Exupload_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Exupload_page'=>$_GET['Exupload_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Exupload_page'=>$_GET['Exupload_page'])); ?>
	</div>

<script>
    $('#Exupload_name_text').change(function() {
        $('#Exupload_url_text').val(cyr2lat($('#Exupload_name_text').val()));
    });
