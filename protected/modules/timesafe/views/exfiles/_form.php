<?php
    ...
    echo CHtml::hiddenField('Exfiles_page',$_GET['Exfiles_page']);
?>
<style>
    .span {
      width: 100%;
...
for ( $i=1; $i<=100; $i++) $number[$i]=$i; ?>
    <div class="form-actions">
    	...
    	<?=CHtml::link('назад', array('list','Exfiles_page'=>$_GET['Exfiles_page'])); ?>    </div>
    ...
    <div class="form-actions">
        ...
        <span class="text_button_padding">или</span>
        <?=CHtml::link('назад', array('list','Exfiles_page'=>$_GET['Exfiles_page'])); ?>
	</div>

<script>
    $('#Exfiles_name_text').change(function() {
        $('#Exfiles_url_text').val(cyr2lat($('#Exfiles_name_text').val()));
    });
