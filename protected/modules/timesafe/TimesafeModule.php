...
class TimesafeModule extends CWebModule
{
    /**
    ...
    {        
        ...
        $this->setImport(array(
              ...
              'timesafe.components.behaviors.*',
              'timesafe.components.dataproviders.*',
              'timesafe.controllers.*',
        ));
    ...
    public function getAssetsUrl()
    {
        if ($this->_assetsUrl === null) {
            $assetsPath = Yii::getPathOfAlias('timesafe.assets');
