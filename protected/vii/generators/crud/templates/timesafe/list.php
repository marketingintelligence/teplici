...
<div class="modal-footer">
    <?='<?php'?> echo CHtml::link('<i class="icon-trash"></i> Удалить', '#',array('class'=>'btn btn-danger modal-delete', 'data-dismiss'=>'modal')); ?>
    <?='<?php'?> echo CHtml::link('<i class="icon-trash"></i> Удалить навсегда', '#', array('class'=>'btn btn-danger modal-delete-forever', 'data-dismiss'=>'modal')); ?>
