...
class ControllerCode extends CCodeModel
{
	...
	{
		$link=CHtml::link('проверить', Yii::app()->createUrl($this->controller), array('target'=>'_blank'));
		return "Контроллер успешно сгенерирован. Можешь $link.";
	}
